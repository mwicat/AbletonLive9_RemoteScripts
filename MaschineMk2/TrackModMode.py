...
# File: TrackModMode.pyc (Python 2.5)
...
class TrackElement:
    ...
    def set_button(self, button, track, mode):
        ...
        if not button == None and isinstance(button, ButtonElement):
            raise AssertionError
        if not track == None and isinstance(track, Live.Track.Track):
            raise AssertionError
        self._track = track
        self._mode = mode
...
class TrackAssign(object):
    ...
    def __init__(self):
        self.track_offset = 0
        self.elements = tuple(lambda .0: for idx in .0:
TrackElement(idx)(range(16)))
...
class TrackModMode(MaschineMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackModMode, self).__init__(*a, **a)
...
class TrackArmMode(TrackModMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackArmMode, self).__init__(track_assign, *a, **a)
        self.exclusive = True
...
class TrackSoloMode(TrackModMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackSoloMode, self).__init__(track_assign, *a, **a)
        self.exclusive = True
    ...
    def _get_color(self, track_ele):
        ...
        if track == None:
            return OFF_COLOR
        elif not track.solo == False or 1:
            pass
        return PColor.SOLO_TRACK[0]
...
class TrackStopMode(TrackModMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackStopMode, self).__init__(track_assign, *a, **a)
    ...
    def _track_status(self, track):
        ...
        return (has_clip, clip_playing, stop_fired, play_fired)
...
class TrackMuteMode(TrackModMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackMuteMode, self).__init__(track_assign, *a, **a)
...
class TrackXFadeMode(TrackModMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackXFadeMode, self).__init__(track_assign, *a, **a)
...
class TrackSelectMode(TrackModMode):
    ...
    def __init__(self, track_assign, *a, **k):
        super(TrackSelectMode, self).__init__(track_assign, *a, **a)
