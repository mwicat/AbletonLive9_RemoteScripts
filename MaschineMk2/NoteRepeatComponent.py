...
# File: NoteRepeatComponent.pyc (Python 2.5)
...
CFG_REPEAT_DISPLAY = [
    ...
    '1/32T',
    '1/64']
CTRL_TO_FREQ = ((40, 4), (45, 4 * t), (41, 8), (46, 8 * t), (42, 16), (47, 16 * t), (43, 32), (48, 32 * t), (44, 64))
...
class NoteRepeatComponent(CompoundComponent):
    ...
    def _adjust_cfg_value(self, value):
        ...
        if button and button.cfg:
            if (self.nr_down and button.hold or self._hold_mode) and button.active:
