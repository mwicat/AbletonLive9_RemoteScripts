...
class Maschine(ControlSurface):
    ...
    def _set_up_session(self, mode_selector):
        ...
        self.nav_buttons = (self.create_gated_button(92, COLOR_HUE_NAV), self.create_gated_button(81, COLOR_HUE_NAV), self.create_gated_button(93, COLOR_HUE_NAV), self.create_gated_button(91, COLOR_HUE_NAV))
    ...
    _on_appointed_device_changed = subject_slot('appointed_device')(_on_appointed_device_changed)
    ...
    _action_toogle_detail_view = subject_slot('value')(_action_toogle_detail_view)
    ...
    _on_change_reenabled = subject_slot('re_enable_automation_enabled')(_on_change_reenabled)
